...
def checkout(request):
    ...
    if request.user.is_authenticated:
        ...
        return render(request, "payment/checkout.html", {"cart_products":cart_products, "quantities":quantities, "totals":totals, "shipping_form":shipping_form, "prices":total_prices, "billing_form":billing_form })
    else:
        # Checkout as guest
...
def billing_info(request):
    if request.POST:
        ...
        if request.user.is_authenticated:
            billing_form = PaymentForm()
            return render(request, "payment/billing_info.html", {"cart_products":cart_products, "quantities":quantities, "totals":totals, "shipping_info":shipping_form, "billing_form":billing_form, "prices":total_prices})
        else:
            billing_form = PaymentForm()
            return render(request, "payment/billing_info.html", {"cart_products":cart_products, "quantities":quantities, "totals":totals, "shipping_info":shipping_form, "billing_form":billing_form, "prices":total_prices})
    else:
